...
class Person_AttributesEntry_DoNotUse final
 ...
 public:
  ...
  explicit Person_AttributesEntry_DoNotUse(::google::protobuf::Arena* arena);
  static const Person_AttributesEntry_DoNotUse* internal_default_instance() {
    return reinterpret_cast<const Person_AttributesEntry_DoNotUse*>(
        &_Person_AttributesEntry_DoNotUse_default_instance_);
  }
...
/* @@protoc_insertion_point(class_definition:example.Person) */ {
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::MapField<Person_AttributesEntry_DoNotUse, std::string, std::string,
                      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
                      ::google::protobuf::internal::WireFormatLite::TYPE_STRING>
        attributes_;
...
inline const ::google::protobuf::Map<std::string, std::string>& Person::_internal_attributes() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.attributes_.GetMap();
}
inline const ::google::protobuf::Map<std::string, std::string>& Person::attributes() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_map:example.Person.attributes)
  return _internal_attributes();
}
inline ::google::protobuf::Map<std::string, std::string>* Person::_internal_mutable_attributes() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.attributes_.MutableMap();
}
inline ::google::protobuf::Map<std::string, std::string>* Person::mutable_attributes() ABSL_ATTRIBUTE_LIFETIME_BOUND {
